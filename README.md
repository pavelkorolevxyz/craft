...
Каталоги и мини-колода открываются напрямую через `file://`. Для первого знакомства начните с [рецептов интерфейсов](catalog/interfaces/recipes.html): там компоненты собраны в рабочие конструкции с готовой разметкой.
