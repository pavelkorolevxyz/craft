...
Слайдовый каталог содержит 28 исходных слайдов и 20 вариантов раскладки. Пошаговые фрагменты разворачиваются в 62 экранные страницы, и все 62 страницы попадают в PDF без анимации. В каталоге остаются 11 канонических фрагментов для композиции новых колод. Все страницы работают через `file://` и используют канонические ассеты.
